...
function SidebarExpand() {
  ...
  return (
    <div
      id="expanded_sidebar"
      className="w-[240px] z-40 h-[91.2vh] fixed top-14 pt-3 pb-4 left-0 right-0 bg-white overflow-y-scroll overflow-hidden hidden md:block"
    >
      <ul className="list-none flex flex-col justify-center px-2">
          ...
          <ul className="list-none flex flex-col justify-center pt-3.5 border-t border-[rgba(0,0,0,0.1)]">
            ...
            {showmore == 'showmore' ? (
              <li
                ...
                className="h-[40px] px-4 flex flex-row justify-start py-2 rounded-xl cursor-pointer hover:bg-[#f2f2f2]"
              >
                <svg viewBox="0 0 24 24" className="w-[25px]">
                  <g>
        ...
        <li className="flex flex-col justify-center mt-3">
          <ul className="list-none flex flex-col justify-center pt-3.5 border-t border-[rgba(0,0,0,0.1)]">
            <h3 className="text-base px-2 py-1 text-[#333] font-normal">
              Subscriptions
            </h3>
            <li className="h-[40px] px-4 flex flex-row justify-start py-2 mb-1 rounded-xl cursor-pointer hover:bg-[#f2f2f2]">
              <img
                ...
                alt=""
              />
              <div className="text-[#333] text-sm font-medium ml-5 overflow-hidden whitespace-nowrap text-ellipsis">
                The Ahmed's
              </div>
            </li>
            <li className="h-[40px] px-4 flex flex-row justify-start py-2 mb-1 rounded-xl cursor-pointer hover:bg-[#f2f2f2]">
        ...
        <li className="flex flex-col justify-center mt-3">
          <ul className="list-none flex flex-col justify-center pt-3.5 border-t border-[rgba(0,0,0,0.1)]">
            <li className="px-4 flex flex-row flex-wrap justify-start py-2 rounded-xl">
              <a
                href=""
                className="text-[#606060] text-sm font-semibold mr-2 flex flex-column justify-center"
              >
                About
              </a>
              <a
